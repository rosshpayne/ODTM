...
Each database operation is represented as an ordered set of stored procedures defined in a single PL/SQL package that you develop utilising DOM’s simple framework to guarantee safe restarting of a failed operation while providing logging of all operations to the DOM server.
